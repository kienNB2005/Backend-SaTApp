...
public enum ErrorCode {
    ...
    ALREADY_LEFT_EARLY(1242, "Bạn đã bị ghi nhận về sớm ở đợt điểm danh trước nên không thể điểm danh tiếp", HttpStatus.BAD_REQUEST),
    ...
    CHECKOUT_EVENT_NOT_FOUND(1219, "Không tìm thấy sự kiện Check-out hợp lệ", HttpStatus.NOT_FOUND),
     ...
     LEFT_EARLY_NOT_ALLOWED(1243, "Không thể đánh dấu về sớm cho sinh viên vắng mặt hoặc có phép", HttpStatus.BAD_REQUEST),
